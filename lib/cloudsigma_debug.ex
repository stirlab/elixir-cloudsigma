defmodule CloudSigma.Debug do
  ...
  def get(path, opts) do
    output CloudSigma.get(path, opts)
    :ok
  end
  ...
  def post(path, data, opts) do
    output CloudSigma.post(path, data, opts)
    :ok
  end
  ...
  def put(path, data, opts) do
    output CloudSigma.put(path, data, opts)
    :ok
  end
  ...
  def delete(path, opts) do
    output CloudSigma.put(path, opts)
    :ok
  end
